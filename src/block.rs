...
impl BlockDriver for Block {
	fn new(idx : usize, header : *mut VirtHeader, page_size : usize)->Self {
	...
	fn write(&mut self, buffer : *mut u8, size : u32, offset : usize) {
	...
	fn read(&mut self, buffer : *mut u8, size : u32, offset : usize) {
